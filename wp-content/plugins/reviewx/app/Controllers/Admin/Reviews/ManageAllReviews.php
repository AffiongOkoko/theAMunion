    ...
    public function wp_list_table_data()
    {
        ...
        foreach ($comments as $comment) {
            ...
            if ( current_user_can( 'edit_post', $post_id ) ) {
                // print_r($post_id);
                // echo '<input type="text" name="productId" value="'.$post_id.'"/>';
                
                //$post_link  = "<a href='" . esc_url( get_edit_post_link( $post_id ) ) . "'>";
                $post_link  = "<a class='rx-single-product' href='#' data-id='$post_id'>";
                // $post_link  = "<button type='button' data-id='$post_id' value='" . get_the_title( $post_id ) . "'/>";
                $post_link .= esc_html( get_the_title( $post_id ) );
                // $post_link .= '<input type="hidden" name="productId" id="'.$post_id.'" value="'.$post_id.'"/>';
